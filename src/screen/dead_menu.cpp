...
{
    Font::render_frame("", 0, 16, 32, 18, 9);
    Font::draw("YOU DIED! AWW!", 13, 32, 48, 2, 5);
    ...
    Font::draw("TIME:", 5, 32, 80, 2, 5);
    if (hours > 0)
    {
        Font::draw(hours, 1, 112, 80, 6, 5);
        Font::draw("H", 1, 128, 80, 6, 5);
        Font::draw(minutes, 2, 160, 80, 6, 5);
        Font::draw("M", 1, 192, 80, 6, 5);
    }
    else
    {
        Font::draw(minutes, 2, 112, 80, 6, 5);
        Font::draw("M", 1, 144, 80, 6, 5);
        Font::draw(seconds, 2, 176, 80, 6, 5);
        Font::draw("S", 1, 208, 80, 6, 5);
    }
    Font::draw("SCORE:", 6, 32, 96, 2, 5);
    Font::draw(game->player->score, 3, 128, 96, 6, 5);
    Font::draw("PRESS 2ND", 9, 32, 128, 3, 5);
    Font::draw("TO LOSE", 7, 32, 144, 3, 5);
}
