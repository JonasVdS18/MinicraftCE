...
void Zombie::render(int x_scroll, int y_scroll)
{
    ...
    if (dir == 0) // if the direction is 0 (Down)...
    {
        ...
        {
            display_sprite = rlet_zombie_front_flipped;
        }
    }
    if (dir == 1) // if the direction is 1 (Up)...
    {
        ...
        {
            display_sprite = rlet_zombie_back_flipped;
        }
    }
    if (dir == 2) // if the direction is 2 (Left)...
    {
        if (!flip)
        {
            display_sprite = rlet_zombie_side_0_flipped;
        }
        else
        {
            display_sprite = rlet_zombie_side_1_flipped;
        }
    }
